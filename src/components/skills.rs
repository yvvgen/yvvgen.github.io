...
pub fn skills() -> Html {
    ...
    html! {
        <section id="skills" class="py-20 bg-base-100 text-base-content">
            <h2 class="text-6xl font-extrabold text-center mb-16 text-neon-secondary">{"Skills & Mastery"}</h2>
            <div class="container mx-auto px-6 max-w-4xl">
                ...
                <div class="mt-12 text-center">
                    <button class="btn btn-accent btn-outline text-xl transition duration-300 transform hover:scale-105 hover:glow-accent">{"Download Resume"}</button>
                </div>
            </div>
        </section>
    }
